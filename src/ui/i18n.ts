...
const STR: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    measureHint: '量测:左键点起点、再点终点,可连续量测多把;右键清除全部标尺并退出',
    measureDist: '距离',
  ...
  en: {
    ...
    measureHint: 'Measure: left-click the start point, then the end point — repeatable; right-click clears all rulers and exits',
    measureDist: 'Dist',
