...
const STR: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    statusFail: '加载失败:',
    paneTree: '文档树', paneObjects: '对象树', paneLayers: '图层',
    searchPh: '搜索…',
    noObjects: '暂无对象',
    noLayers: '当前文档没有图层',
  ...
  en: {
    ...
    paneTree: 'Documents', paneObjects: 'Objects', paneLayers: 'Layers',
    searchPh: 'Search…',
...
const TYPES: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    DEVICE: '设备', SIMULATION: '仿真', SIMULATION_SCH: '仿真原理图', SCH_PAGE: '原理图页',
...
const ATTRS: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    fontSize: '字号', strokeWidth: '线宽', width: '宽度', height: '高度',
    ...
    symbol: '符号', footprint: '封装', device: '设备', uuid: 'UUID',
  ...
  en: {
    ...
    fontSize: 'Font size', strokeWidth: 'Stroke width', width: 'Width', height: 'Height',
    ...
    symbol: 'Symbol', footprint: 'Footprint', device: 'Device', uuid: 'UUID',
